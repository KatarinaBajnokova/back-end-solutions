...
include 'header.php';
// Creating an array of 10 animals in two different ways
...
// Creating a 2-dimensional array of vehicles categorized by type
$vehicles = [
...
// Part 2: Creating an array of numbers
$numbers = [1, 2, 3, 4, 5];

// Multiplying all numbers together
$product = array_product($numbers);

// Filtering and finding odd numbers
$oddNumbers = array_filter($numbers, fn($num) => $num % 2 !== 0);

// Creating the second array
$numbers2 = [5, 4, 3, 2, 1];

// Adding the numbers from both arrays together
